...
*/
// module validateExistingResources 'modules-network-secured-no-deps/validate-existing-resources.bicep' = {
...
// module aiDependencies 'modules-network-secured-no-deps/standard-dependent-resources.bicep' = {
